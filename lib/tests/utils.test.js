...
describe("util", () => {
  ...
  describe('setOutput', () => {
    ...
    it('should set output', () => {
      const output = `google provider, version 'v23.01.00116' successfully installed
      [{"name":"gke-stackql-demo-cluster-default-pool-9f8f9edf-91w8","status":"RUNNING"},{"name":"gke-stackql-demo-cluster-default-pool-9f8f9edf-a5ep","status":"RUNNING"},{"name":"gke-stackql-demo-cluster-default-pool-9f8f9edf-pat4","status":"RUNNING"},{"name":"stackql-demo-001","status":"TERMINATED"},{"name":"stackql-demo-002","status":"RUNNING"},{"name":"stackql-demo-003","status":"RUNNING"},{"name":"stackql-demo-004","status":"TERMINATED"},{"name":"stackql-demo-013","status":"RUNNING"},{"name":"stackql-demo-014","status":"RUNNING"}]`;
      setOutput(core, 'test', JSON.stringify(output));
      expect(core.setOutput).toBeCalledWith("test", JSON.stringify(output));
    });
